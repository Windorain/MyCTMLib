...
public final class ConnectingTilePipeline {
    ...
    public static void execute(RenderContext ctx) {
        ...
        ctx.trace("IconDomain: icon=[" + formatDouble(ctx.getIconMinU()) + "," + formatDouble(ctx.getIconMaxU()) 
                  + "," + formatDouble(ctx.getIconMinV()) + "," + formatDouble(ctx.getIconMaxV()) + "]"
        ...
        ctx.trace("GeometryDomain: relMin=[" + formatDouble(ctx.getDrawRelMinX()) + "," + formatDouble(ctx.getDrawRelMinY()) + "," + formatDouble(ctx.getDrawRelMinZ()) + "]"
                  + ", relMax=[" + formatDouble(ctx.getDrawRelMaxX()) + "," + formatDouble(ctx.getDrawRelMaxY()) + "," + formatDouble(ctx.getDrawRelMaxZ()) + "]");
        
        UVDomain.calc(ctx);
        ctx.trace("UVDomain: drawUV=[" + formatDouble(ctx.getDrawMinU()) + "," + formatDouble(ctx.getDrawMaxU()) 
                  + "," + formatDouble(ctx.getDrawMinV()) + "," + formatDouble(ctx.getDrawMaxV()) + "]");
        
        PositionDomain.calc(ctx);
        ctx.trace("PositionDomain: world=[" + formatDouble(ctx.getWorldX()) + "," + formatDouble(ctx.getWorldY()) + "," + formatDouble(ctx.getWorldZ()) + "]");
