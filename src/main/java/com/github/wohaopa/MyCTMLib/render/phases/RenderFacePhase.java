...
public class RenderFacePhase implements PipelinePhase {
    ...
    public PhaseResult process(RenderContext context) {
        ...
        FaceRenderer.drawFace(
            ...
            width,
            height,
            context.getDrawBrightness(),
            context.getDrawRelMinX(),
            context.getDrawRelMaxX(),
            context.getDrawRelMinY(),
            context.getDrawRelMaxY(),
            context.getDrawRelMinZ(),
            context.getDrawRelMaxZ(),
            baseData,
